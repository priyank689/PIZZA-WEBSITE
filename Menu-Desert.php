...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: Menu-Desert.php");
        exit();
    } 
}
?>
...
<!-- FORM -->
    ...
    <div class="navbarstyleouter" style="margin-top: 7rem;background-color: white;">
      <div class="navbarstyle" style="width: 45%; margin-left: 27%;">
        <h5 class="all" class="all" style="border-radius: 5rem;"><button class="all1" id="all-navbar" >ALL</button></h5>
        <h5><button class="button2" class="all1" id="nav-burger">BURGERS</button></h5>
        <h5><button class="button2" style="background-color: orange; color: white;" id="nav-deserts">DESERTS</button></h5>
...
<!-- menu section -->
  ...
  <div class="fourth" style="height: 52rem; padding-bottom: 4rem;background-color: white;">
      

    <div class="first product" style="margin-top: 0rem;background-color: white;">
        <img src="pink doughnut.png" alt="" style="padding-left: 2.5rem;background-color: white; margin-left: 3rem; width: 17rem; height: 15rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">PINK DOUGHNUT</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $30.00</h7>
        <button onclick="addToCart('PINK DOUGHNUT', 1893)">ORDER NOW</button>
      </div>
    
    <div class="first product" style="margin-top: -1.1rem;background-color: white;">
        <img src="ice coffee.png" alt="" style="padding-left: 2rem;background-color: white; margin-left: 6.3rem; width: 10rem; height: 14rem; margin-top: 2rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">ICE COFFEE</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
    ...
    <div class="first product" style=" margin-top: -0.1rem;background-color: white;">
        <img src="delicious coffee.png" alt="" style="padding-left: 2.5rem; margin-left: 4.3rem;background-color: white; width: 13rem; height: 15rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">DELICIOUS COFFEE</h5>
        <p style="padding-left: 2rem;background-color: white; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $30.00</h7>
     ...
     <div class="first product" style=" margin-top: 1rem;background-color: white;">
        <img src="chocolate cookies.png" alt="" style="padding-left: 2.5rem;background-color: white; margin-left: 2.8rem; width: 16rem; height: 14rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">CHOCOLATE COOKIES</h5>
        <p style="padding-left: 2rem;background-color: white; color: rgb(183, 177, 177)">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $30.00</h7>
    ...
    <div class="first product" style="margin-top: 1rem;background-color: white;">
        <img src="cream and green desert.png" alt="" style="padding-left: 2rem;background-color: white; margin-left: 4rem; width: 15rem; height: 15rem; margin-top: 0rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">CREAM AND GREEN</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
