...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: Menu-Burger.php");
        exit();
    } 
}
?>
...
<!-- FORM -->
    ...
    <div class="navbarstyleouter" style="margin-top: 5rem;background-color: white;">
      <div class="navbarstyle" style="width: 45%; margin-left: 27%;">
        ...
        <h5><button class="button2" style="background-color: orange; color: white;" id="nav-burger">BURGERS</button></h5>
...
<!-- menu section -->
  ...
  <div class="fourth" style="height: 31rem; padding-bottom: 4rem;background-color: white;">
      ...
      <div class="first product" style="margin-top: 0.5rem;background-color: white;">
        <img src="sollowburger.png" alt="" style="padding-left: 1.rem;background-color: white;" />
        <h5 style="padding-left: 0.2rem;background-color: white;color: black;">SOLLOW BURGER</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $70.00</h7>
        <button onclick="addToCart('CHOCOLATE COOKIES', 1893)">ORDER NOW</button>
      </div>
      
      <div class="first product" style="background-color: white;">
        <img src="freshburger.png" alt="" style="padding-left: 1.3rem; margin-top: 0.6rem;background-color: white;" />
        <h5 style="padding-left: 0.7rem;background-color: white;color: black;">GREEN SALAD</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $12.00</h7>
        <button onclick="addToCart('CHOCOLATE COOKIES', 1893)">ORDER NOW</button>
      </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------- -->

      <div class="first product" style="margin-top: 3.9rem;background-color: white;">
        <img src="veggie combo burger.png" alt="" style="padding-left: 2rem;background-color: white; width: 21rem; height: 15rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">Veggie Combo</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
      ...
      <!--  -->
      <div class="first product" style="margin-top: 2.1rem;background-color: white;">
        <img src="veggie supreme burger.png" alt="" style="padding-left: 2rem;background-color: white; width: 20rem; height: 15rem; margin-top: 2rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">Veggie Supreme</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
