...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: Menu-Drinks.php");
        exit();
    } 
}
?>
...
<!-- FORM -->
    ...
    <div class="navbarstyleouter" style="margin-top: 7rem;background-color: white;">
      <div class="navbarstyle" style="width: 45%; margin-left: 27%;">
        ...
        <h5><button class="button2" style="background-color: orange; color: white;" id="nav-drinks">DRINKS</button></h5>
...
<!-- menu section -->
  ...
  <div class="fourth" style="height: 31rem; padding-bottom: 4rem;background-color: white;">
      
    <div class="first2 product" style="margin-top: 0.8rem;background-color: white;">
        <img src="lemonjuice.png" alt="" style="padding-left: 2rem;background-color: white;" />
        <h5 style="padding-left: 1rem;background-color: white;color: black;">LEMON JUICE</h5>
        <p style="padding-left: 2rem;background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $16.00</h7>
        <button onclick="addToCart('LEMON JUICE', 1893)">ORDER NOW</button>
      </div>

      <div class="first1 product" style="background-color: white;">
        <img src="specialdrink.png" alt="" style="background-color: white;"/>
        <h5 style="padding-left: 1rem;background-color: white;color: black;">SPECIAL DRINK</h5>
        <p style="padding-left: 2rem;background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
        <h7 style="color: orange; margin-left: 10.5rem;background-color: white;"> $90.00</h7>
        <button onclick="addToCart('SPECIAL DRINK', 1893)">ORDER NOW</button>
      </div>

      <div class="first product" style="margin-top: 4.1rem;background-color: white;">
        <img src="extra drink.png" alt="" style="padding-left: 0rem; width: 17rem; height: 15rem;background-color: white;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">EXTRA DRINK </h5>
      ...
      <div class="first product" style="margin-top: 4.2rem;background-color: white;">
        <img src="rum with soda.png" alt="" style="padding-left: 2rem;background-color: white; margin-left: 4rem; width: 15rem; height: 15rem; margin-top: 0rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;background-color: white;color: black;">RUM WITH SODA</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177);background-color: white;">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
        </p>
