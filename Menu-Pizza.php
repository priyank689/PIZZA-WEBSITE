...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: Menu-Pizza.php");
        exit();
    } 
}
?>
    ...
    <div class="richresturant">
     ...
     <div class="navbarstyleouter" style="margin-top: 10rem;">
      <div class="navbarstyle" style="width: 45%; margin-left: 27%;">
        ...
        <h5><button class="button2" style="background-color: orange; color: white;" id="nav-pizzas">PIZZAS</button></h5>
...
<!-- menu section -->
  ...
  <div class="fourth" style="height: 53rem; padding-bottom: 4rem; margin-top: 5rem;">
      
   <div class="first product" style="margin-top: -5rem;">
      ...
      <div class="first product" style=" margin-top: -5rem;">
        <img src="garlink pizza.png" alt="" style="padding-left: 2.5rem; margin-left: 2.3rem; width: 17rem; height: 15rem;" />
      ...
      <div class="first product" style="margin-top: 1rem;">
        <img src="pepperoni pizza.png" alt="" style="padding-left: 0rem; width: 14rem; height: 15rem; margin-left: 5.5rem;" />
        <h5 style="padding-left: 1rem; padding-top: 1.5rem;">ITALIAN PIZZA</h5>
        <p style="padding-left: 2rem; color: rgb(183, 177, 177)">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus…
