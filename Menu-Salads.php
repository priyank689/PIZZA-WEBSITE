...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: Menu-Salads.php");
        exit();
    } 
}
?>
...
<!-- FORM -->
    ...
    <div class="navbarstyleouter" style="margin-top: 10rem;">
      <div class="navbarstyle" style="width: 45%; margin-left: 27%;">
        ...
        <h5 style="border-radius: 5rem;"><button class="button2" style="background-color: orange; color: white;" id="nav-salads">SALADS</button></h5>
      </div>
    </div>
...
<!-- menu section -->
  ...
  <div class="fourth" style="height: 31rem; padding-bottom: 4rem;">
      
      <div class="first product" style="margin-top: 3.2rem;">
        <img src="caesar salad.png" alt="" style="padding-left: 2.5rem; margin-left: 2.8rem; width: 18rem; height: 16rem;" />
      ...
      <div class="first product" style="margin-top: -5.5;">
      ...
      <div class="first product" style="margin-top: 0.85rem;">
        <img src="meatsalad.png" alt="" style="padding-left: 1rem" />
